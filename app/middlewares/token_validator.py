...
async def access_control(request: Request, call_next):
    ...
    try:
        if url.startswith("/api"):
            ...
            cookies["Authorization"] = "Bearer Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MiwiZW1haWwiOiJ1c2VyMUBleGFtcGxlLmNvbSIsIm5hbWUiOm51bGwsInBob25lX251bWJlciI6bnVsbCwicHJvZmlsZV9pbWciOm51bGwsInNuc190eXBlIjpudWxsfQ.RSc_ITrLNwvrmC69IQzEtlFT9cuE7sP11MklESX-Q1s"
        ...
        response = await call_next(request) # 함수를 실행한다 (API)
        await api_logger(request=request, response=response)
